...
class NotificationService {
  ...
  NotificationService({
    ...
    MessagingServiceInterface? messagingService,
       ...
       _notificationDatabaseService = notificationDatabaseService ?? NotificationDatabaseService(),
  ...
  Future<List<Notification>> getUnreadNotifications() async {
    try {
      ...
      Logger.e('Error getting unread notifications: $e', tag: 'NotificationService');
      return [];
    }
  }
  ...
  Future<void> markAsRead(String notificationId) async {
    try {
      ...
      Logger.e('Error marking notification as read: $e', tag: 'NotificationService');
  ...
  Future<void> markAllAsRead() async {
    try {
      ...
      Logger.e('Error marking all notifications as read: $e', tag: 'NotificationService');
  ...
  Future<void> createBookingConfirmationNotification(Booking booking) async {
    try {
      ...
      final notification = Notification(
        ...
        body: 'Your booking for ${booking.serviceName} on ${_formatDate(booking.bookingDateTime)} has been confirmed.',
      ...
      Logger.i('Booking confirmation notification created', tag: 'NotificationService');
    } catch (e) {
      Logger.e('Error creating booking confirmation notification: $e', tag: 'NotificationService');
    }
  }
  
  /// Create a booking update notification
  Future<void> createBookingUpdateNotification(Booking booking, String updateMessage) async {
    try {
      final userId = booking.userId;
      ...
      Logger.i('Booking update notification created', tag: 'NotificationService');
    } catch (e) {
      Logger.e('Error creating booking update notification: $e', tag: 'NotificationService');
    }
  }
  ...
  Future<void> createBookingReminderNotification(Booking booking, int daysBeforeEvent) async {
    try {
      ...
      final notification = Notification(
        ...
        body: 'Reminder: Your booking for ${booking.serviceName} is in $daysBeforeEvent ${daysBeforeEvent == 1 ? 'day' : 'days'} on ${_formatDate(booking.bookingDateTime)}.',
      ...
      Logger.i('Booking reminder notification created', tag: 'NotificationService');
    } catch (e) {
      Logger.e('Error creating booking reminder notification: $e', tag: 'NotificationService');
    }
  }
  ...
  Future<void> createBookingCancellationNotification(Booking booking) async {
    try {
      ...
      final notification = Notification(
        ...
        body: 'Your booking for ${booking.serviceName} on ${_formatDate(booking.bookingDateTime)} has been cancelled.',
      ...
      Logger.i('Booking cancellation notification created', tag: 'NotificationService');
    } catch (e) {
      Logger.e('Error creating booking cancellation notification: $e', tag: 'NotificationService');
    }
  }
  ...
  Future<void> _sendEmailNotification({
    ...
    Logger.i('Would send email to user $userId: $subject', tag: 'NotificationService');
  }
}
