...
import 'celebration_checklist_screen.dart';
import 'package:eventati_book/utils/utils.dart';

class CelebrationWizardScreen extends StatefulWidget {
  const CelebrationWizardScreen({super.key});

  @override
  State<CelebrationWizardScreen> createState() =>
      _CelebrationWizardScreenState();
}

class _CelebrationWizardScreenState extends State<CelebrationWizardScreen> {
  int _currentStep = 0;
  ...
  final List<String> _celebrationEventTypes = [
    'Birthday Party',
    'Anniversary',
    'Graduation',
    'Baby Shower',
                        ...
                        onPressed: () {
                          if (_currentStep < 3) {
                            ...
                            Navigator.pushReplacement(
                              ...
                              MaterialPageRoute(
                                builder:
                                    (context) => CelebrationChecklistScreen(
                ...
                content: Column(
                  children: [
                    ...
                    EventTypeDropdown(
                      ...
                      eventTypes: _celebrationEventTypes,
                      primaryColor: primaryColor,
                      onChanged: (value) {
