...
class StepProgressIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final disabledColor = inactiveColor ?? 
      Color.fromRGBO(
  ...
  Widget _buildLinearIndicator(Color activeColor, Color inactiveColor, double progress) {
    return Container(
      height: height,
  ...
  Widget _buildStepLabels(Color activeColor, Color inactiveColor, BuildContext context) {
    return Row(
