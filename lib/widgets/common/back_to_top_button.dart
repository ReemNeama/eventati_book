...
class _BackToTopButtonState extends State<BackToTopButton> with SingleTickerProviderStateMixin {
  ...
  void _scrollListener() {
    if (widget.scrollController.offset >= widget.scrollThreshold && !_showButton) {
      setState(() {
        _showButton = true;
      });
      _animationController.forward();
    } else if (widget.scrollController.offset < widget.scrollThreshold && _showButton) {
      setState(() {
        _showButton = false;
      });
  ...
  Widget build(BuildContext context) {
    ...
    final defaultIconColor = widget.iconColor ?? 
      (isDarkMode ? theme.primaryColor : Colors.white);
    ...
    return Positioned(
      ...
      right: widget.position == BackToTopButtonPosition.bottomRight ? widget.padding.right : null,
      left: widget.position == BackToTopButtonPosition.bottomLeft ? widget.padding.left : null,
      child: widget.position == BackToTopButtonPosition.bottomCenter
          ? Center(child: button)
          : button,
    );
  }
