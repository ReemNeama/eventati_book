...
import 'package:eventati_book/utils/string_utils.dart';
...
void main() {
  group('StringUtils Tests', () {
    ...
    test('capitalizeEachWord should capitalize each word in a string', () {
      ...
      expect(StringUtils.capitalizeEachWord('hello world'), equals('Hello World'));
    ...
    test('truncate should truncate a string to a maximum length', () {
      ...
      expect(StringUtils.truncate('Hello World', 5, ellipsis: '...!'), equals('Hello...!'));
    ...
    test('isValidPhoneNumber should check if a string is a valid phone number', () {
